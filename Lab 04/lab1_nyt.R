...
require(kknn)
nyt1<-read.csv("/Applications/Gursimran/RPI/Semester 2/Data Analytics/Tasks/Lab 04/Data/nyt1.csv")
...
classif <- kknn(Gender ~ Age + Impressions, train, cg, k = 5)
classif
attributes(.Last.valu)
